...
function showReady(): void {
  status.textContent = 'Microphone is ready. Return to Outfitters and reopen Dhaaga.';
  status.className = 'status success';
  message.textContent = 'Permission granted. Dhaaga will access the microphone only when you tap the mic button.';
